      ...
      <div class="full-width-split__inner">
       ...
       $today = date('Ymd');
          ...
          $homepageEvents = new WP_Query(array(
            'posts_per_page' => 2, //-1 will give all details
            'post_type' => 'event',
            'meta_key' => 'event_date',
          ...
          while ($homepageEvents->have_posts()) {
              ...
              //importing the files
              get_template_part('template-parts/content', 'event'); //location frist arguments
      ...
      <div class="full-width-split__inner">
       ...
       <?php
          ...
          $homepagePosts = new WP_Query(array(
              'posts_per_page' => 2,  //return 2 post per page
        ...
        <?php
         } wp_reset_postdata(); //for clearing global variables and more
